...
//		HTML glue2 = new HTML("&nbsp;");
//		buttonBar.add(glue2);
//		buttonBar.setCellWidth(glue2, "100%");
//		buttonBar.addStyleName("dialog-ButtonBar");
//		PushButton hide = new PushButton("Close");
...
//		});
//		buttonBar.add(hide);
//		buttonBar.setCellHorizontalAlignment(hide, HasHorizontalAlignment.ALIGN_RIGHT);
	...
	public void setTitle(String title) {
	 ...
	 @Override
	    ...
	    private boolean isCloseEvent(NativeEvent event)
	      {
	        return event.getEventTarget().equals(x.getElement());//compares equality of the underlying DOM elements
	      }

...
public class Utils {
	...
	private static DateTimeFormat dateFormater = DateTimeFormat.getFormat("dd/MM/yyyy");
	private static DateTimeFormat shortDateFormater = DateTimeFormat.getFormat("dd/MM");
